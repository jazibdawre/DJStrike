...
const services_data = [
{ name: "Autonomous", icon: "Autonomous" },
{ name: "Voice Control", icon: "VoiceControll" },
{ name: "Line Follow", icon: "LineFollowing" },
{ name: "GUI Control", icon: "GUIContoller" },
{ name: "Obstacle\nAvoidance", icon: "ObstacleAvoidance" },
{ name: "Joy\nStick", icon: "JoyStick" },
{ name: "Manual", icon: "Manual" }];
